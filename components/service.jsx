        ...
        <div class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          <div class="relative overflow-hidden rounded-lg border bg-background p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">Skin Builder</h3>
                <p class="text-sm text-muted-foreground">
                  An AI-powered prompt builder to help you create 
                  stunning designs and images for your tank.
                </p>
              </div>
            </div>
          </div>
          <div class="relative overflow-hidden rounded-lg border bg-background p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">Control skin size and orientation </h3>
                <p class="text-sm text-muted-foreground">
                  Choose from 16x16, 32x32, 64x64, or 128x128 size skin.
                </p>
              </div>
            </div>
          </div>
          <div class="relative overflow-hidden rounded-lg border bg-background p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">Advanced Tuning</h3>
                <p class="text-sm text-muted-foreground">
                  Advanced options for adjusting and Customizing your design.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative overflow-hidden rounded-lg border bg-background p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">Use reference images</h3>
                <p class="text-sm text-muted-foreground">
          ...
          <div class="relative overflow-hidden rounded-lg border bg-background p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">Color palette control</h3>
                <p class="text-sm text-muted-foreground">
